...
\riskdescription{L’uso intensivo delle \gls{api} di Claude potrebbe superare il budget assegnato o incorrere in \textit{rate‑limit}, rendendo la funzionalità economicamente insostenibile}
...
\begin{risk}{Usabilità dell’interfaccia web}
